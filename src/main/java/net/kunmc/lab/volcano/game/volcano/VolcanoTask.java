...
public class VolcanoTask {
    ...
    public static void putLava(VolcanoAttribute volcano) {
        ...
        int startX = pointX + getRangeMinValue(getRangeRandomValue((volcano.getCurrentMaxHeight() / 2)), volcano.getMaxWidth());
        int startZ = pointZ + getRangeMinValue(getRangeRandomValue((volcano.getCurrentMaxHeight() / 2)), volcano.getMaxWidth());
